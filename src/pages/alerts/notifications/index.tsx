...
export default function Notifications() {
  ...
  const channelPerformanceOption = {
    ...
    radar: {
      indicator: notificationData.channelPerformance.channels.map(
        (channel) => ({
          name: channel,
          max: 100,
        })
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Monitor notification delivery, performance, and user engagement
      ...
      <div id="notifications-dashboard">
        ...
        >
          ...
          <div key="channel-performance">
            ...
            >
              <ReactECharts
                option={channelPerformanceOption}
                style={{ height: '300px' }}
              />
            </BaseWidget>
          </div>
          ...
          <div key="notification-types">
            ...
            >
              <ReactECharts
                option={notificationTypesOption}
                style={{ height: '300px' }}
              />
            </BaseWidget>
          </div>
