      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Monitor and manage cost-related alerts, thresholds, and automated
            responses.
          </p>
        </div>
        <TooltipProvider>
      ...
      <div id="cost-alerts-dashboard">
        ...
        >
          ...
          <div key="threshold-breaches">
            ...
            >
              <ReactECharts
                option={thresholdBreachesOption}
                style={{ height: '300px' }}
              />
            </BaseWidget>
          </div>
