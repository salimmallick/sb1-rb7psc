      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Monitor training progress, simulation results, and identify skill
            gaps in alert management.
          </p>
        </div>
        <TooltipProvider>
          <Tooltip>
      ...
      <div id="alerts-training-dashboard">
        ...
        >
          ...
          <div key="simulation-results">
            ...
            >
              <ReactECharts
                option={simulationResultsOption}
                style={{ height: '300px' }}
              />
            </BaseWidget>
          </div>
